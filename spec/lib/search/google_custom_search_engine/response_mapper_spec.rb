RSpec.describe Search::GoogleCustomSearchEngine::ResponseMapper do
  describe '#mapped_response' do
    ...
    before do
      allow_any_instance_of(Search::GoogleCustomSearchEngine::ResponseItemMapper)
    ...
    context 'for each item' do
      it 'instantiates an item mapper' do
        expect(Search::GoogleCustomSearchEngine::ResponseItemMapper)

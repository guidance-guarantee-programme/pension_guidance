RSpec.describe IncomeTaxCalculator do
  ...
  describe '.marginal_tax_for_lump_sum_with_income' do
    ...
    context 'when income is 0' do
      ...
      describe 'and taxable portion of lump sum is within the higher rate band' do
        ...
        it { is_expected.to eq(basic: 6357, higher: 886, additional: 0) }
      end
    ...
    context 'when income is within the basic rate band' do
      ...
      describe 'and taxable portion of lump sum is within the higher rate band' do
        ...
        it { is_expected.to eq(basic: 5557, higher: 886, additional: 0) }
      end
  ...
  [
    ...
    { income: 30_000, lump_sum: 50_000, lump_sum_tax: 12_443, lump_sum_received: 37_557 },
    { income: 0, lump_sum: 160_000, lump_sum_tax: 41_243, lump_sum_received: 118_757 },

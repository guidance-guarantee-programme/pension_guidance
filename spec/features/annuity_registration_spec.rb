RSpec.feature 'Register for an annuities appointment' do
  ...
  def when_i_complete_annuities_preregistration # rubocop:disable Metrics/MethodLength
    ...
    fill_in 'How much do you get from your annuity?', with: '254'
    choose 'Face to face'
    fill_in 'What would you like to get from the appointment?', with: "help\nlots of help"
  ...
  def then_my_details_have_stored_for_future_contact
    expect(test_api.last_called_with).to include(
      ...
      custom_fields: {
        id: nil,
        value: 'Rick,Sanchez,07111111111,rick@sanhez.com,RS1 1SR,101,254,face_to_face,in_own_name,help lots of help'
      }
    )
  end
end

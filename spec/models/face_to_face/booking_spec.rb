RSpec.describe FaceToFace::Booking do
  let(:attributes) do
    {
      'first_name' => 'Bob',
      'last_name' => 'Smith',
  ...
  context 'when adjustments are specified' do
    let(:adjustment_attributes) do
      {
    ...
    subject { described_class.new(attributes.merge(adjustment_attributes)) }

    it 'requires adjustments' do
      subject.adjustments = nil
